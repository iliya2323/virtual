...
declare class Renderer extends AbstractService {
     ...
     */
    setCustomRenderer(factory: (renderer: WebGLRenderer) => Omit<Renderer$1, 'domElement'>): void;
    /**
...
declare abstract class AbstractAdapter<TPanorama, TTexture> {
     ...
     */
    abstract loadTexture(panorama: TPanorama, newPanoData?: PanoData | PanoDataProvider, useXmpPanoData?: boolean): Promise<TextureData<TTexture, TPanorama>>;
    /**
     * Creates the mesh
     */
 ...
 */
type TextureData<T = Texture | Texture[] | Record<string, Texture>, P = any> = {
    texture: T;
    panoData?: PanoData;
    panorama: P;
};
 ...
 */
interface ConfigParser<T, U extends T> {
    (config: T): U;
    defaults: Required<U>;
...
declare namespace index {
  export {
    ...
    index_TouchData as TouchData,
    index_getTouchData as getTouchData,
    index_isFullscreenEnabled as isFullscreenEnabled,
    index_requestFullscreen as requestFullscreen,
    index_exitFullscreen as exitFullscreen,
    index_wrap as wrap,
    index_sum as sum,
    ...
    index_invertResolvableBoolean as invertResolvableBoolean,
    ...
    index_ConfigParser as ConfigParser,
